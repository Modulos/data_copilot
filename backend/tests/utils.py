...
from backend.crud.users import crud_get_user_by_email
from backend.database.psql import SessionLocal
from backend.main import app
from backend.schemas.authentication import User
from backend.utils.authentication import create_access_token
